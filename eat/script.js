(function () {
  ...
  var RESTAURANTS = [
    ...
    { id: "mkrestaurant", name: "MK สุกี้ สาขาสยามพารากอน", category: "food", area: "สยามพารากอน", lat: 13.7460, lng: 100.5347, description: "สุกี้แบรนด์คนไทยที่คุ้นเคย บริการเร็ว เมนูครบ เหมาะกับมื้อครอบครัว", tags: ["สุกี้", "แบรนด์คนไทย"], menu: ["ชุดสุกี้รวมมิตร", "เต้าหู้ทอด", "ไข่ตุ๋น"] },
    ...
    { id: "mkladprao", name: "MK สุกี้ สาขาเซ็นทรัลลาดพร้าว", category: "food", area: "เซ็นทรัลลาดพร้าว", lat: 13.8154, lng: 100.5613, description: "สุกี้แบรนด์คนไทยที่คุ้นเคย สาขาย่านลาดพร้าว-จตุจักร ใกล้รถไฟฟ้าหมอชิต", tags: ["สุกี้", "แบรนด์คนไทย"], menu: ["ชุดสุกี้รวมมิตร", "เต้าหู้ทอด", "ไข่ตุ๋น"] },
