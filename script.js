...
feedbackDuration.addEventListener('change', () => { clearInterval(feedbackTimerId); feedbackSeconds = Number(feedbackDuration.value); renderFeedbackTimer(); const button = document.querySelector('#feedbackTimerBtn'); button.dataset.running = 'false'; button.textContent = 'เริ่มจับเวลา'; });
